...
export function Details() {
    ...
    function handleOrderClose() {
        if (!solution) {
            return Alert.alert('Solicitação', 'Por favor, informe a solução do problema, para encerrar a solicitação.');
        }
        ...
        fireStore()
            ...
            .catch((error) => {
                console.log(error);
                Alert.alert('Solicitação', 'Ocorreu um erro ao encerrar a solicitação.');
            });
    }
